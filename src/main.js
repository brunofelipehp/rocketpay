...
const expirationData = document.querySelector("#expiration-date")
...
const expirationDataMasked = IMask(expirationData, expirationDataPattern)
...
expirationDataMasked.on("accept", () => {
  updateExpirationData(expirationDataMasked.value)
})
